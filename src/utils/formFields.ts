export const formFields = {
    ...
    energyRating: {
      ...
      propertyType: {
        label: 'Property Type',
        inputType: 'select',
        options: ['Studio Flat (Single occupant)', 'Bedsit (Single Occupant)', 'Detached House', 'Semi-Detached House', 'Terraced House', 'Bungalow', 'End Terrace', 'Flat', 'Penthouse Flat', 'Maisonette Flat', 'Mobile Home', 'House Boat']
      },
      floor: {
        label: 'Floor',
        inputType: 'select',
      ...
      furnishing: {
        label: 'Furnishing',
        inputType: 'select',
        options: ['Furnished', 'Unfurnished', 'Semi-Furnished', 'Furnishing at choice of tenant']
      },
      parking: {
        label: 'Parking',
        inputType: 'select',
      ...
      propertyFeatures: {
        ...
        inputType: 'checkbox',
        options: ['Bike Store', 'Garden', 'Fireplace', 'Elevator in building', 'Electric Heating', 'Gas heating', 'Visitor parking']
      },
      minimumTenancyTerm: {
  ...
  imagesOfInteriorAndExterior: {
    label: 'Have you included images of both the interior and exterior of the property?',
    inputType: 'radio',
    options: ['Yes', 'No']
  },
  newlyTakenImages: {
    label: 'Are the images newly taken as part of the current property listing process?',
    inputType: 'radio',
    options: ['Yes', 'No']
  },
  phoneNumber: {
